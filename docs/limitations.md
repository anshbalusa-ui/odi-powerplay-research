...
Current reproducible pitch coverage is **65 of 1,094 primary matches (5.94150%)**.
All 65 are AI-assisted first-pass codes from non-ESPN, match-specific pre-match
...
The separate tracked verified release contains 65 cited scheduled starts, one for
...
powerplay columns. The first four balanced batches and five newest-first batches
reviewed 225 matches: 65 passed, while 160 are explicitly listed in
`data/manual/pitch_set_aside.csv` for later work. This 28.9% yield among reviewed
