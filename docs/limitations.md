...
Current reproducible pitch coverage is **55 of 1,094 primary matches (5.02742%)**.
All 55 are AI-assisted first-pass codes from non-ESPN, match-specific pre-match
...
The separate tracked verified release contains 55 cited scheduled starts, one for
...
powerplay columns. The first four balanced batches and four newest-first batches
reviewed 200 matches: 55 passed, while 145 are explicitly listed in
`data/manual/pitch_set_aside.csv` for later work. This 27.5% yield among reviewed
