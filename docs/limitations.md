...
Current reproducible pitch coverage is **49 of 1,094 primary matches (4.47898%)**.
All 49 are AI-assisted first-pass codes from non-ESPN, match-specific pre-match
...
The separate tracked verified release contains 49 cited scheduled starts, one for
...
powerplay columns. The first four balanced batches and three newest-first batches
reviewed 175 matches: 49 passed, while 126 are explicitly listed in
`data/manual/pitch_set_aside.csv` for later work. This 28.0% yield among reviewed
